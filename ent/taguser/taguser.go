...
const (
	// Label holds the string label denoting the taguser type in the database.
	Label = "tag_user"
	...
	EdgeUser = "user"
	// Table holds the table name of the taguser in the database.
	Table = "tag_users"
...
// Columns holds all SQL columns for taguser fields.
var Columns = []string{
	FieldID,
	FieldTagID,
	FieldUserID,
...
// OrderOption defines the ordering options for the TagUser queries.
